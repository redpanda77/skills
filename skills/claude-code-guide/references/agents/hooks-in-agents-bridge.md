...
This file is intentionally **small**. Hook mechanics live in **`references/hooks`**.
...
Details also documented in `references/hooks` (`hooks-in-skills-and-agents.md`).

## When to jump to `references/hooks`
