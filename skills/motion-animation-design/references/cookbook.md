---
name: motion-cookbook
description: All motion recipes — enter/exit, easing, springs, clip-path, @property, FLIP, scroll-driven, button feedback, icon swaps, and shared layout. The single source of truth for motion implementation code.
---

# Motion Cookbook

The single source of truth for motion **recipes** — implementation patterns and code. In Create mode this is your primary reference; in Audit mode load it when making implementation recommendations.
