---
name: anti-checklist
description: Quality gate for AI-slop motion patterns. Categories of motion to flag during audits, with flagging heuristics so single intentional uses don't trip the gate.
---

# Anti-Checklist

This file is the audit's quality gate. The categories below describe motion patterns to **flag** in audited code — AI-slop tells at the top (where most 2026 motion problems live), followed by perspective-specific and general anti-patterns. When audited code matches a pattern here, the audit surfaces a finding and the agent generates a per-finding motion suggestion by reading the relevant philosophy reference.

---

## AI-Slop Motion Patterns

These are the recognizable motion fingerprints of AI-generated UIs in 2026. They're not always wrong in isolation — what makes them slop is *frequency* and *uniformity*. Finding one instance is normal polish; finding the same pattern slapped across the codebase is the tell.
...
**Fix lens:** Emil — purposeful restraint. See `references/perspectives/emil-kowalski.md`.
...
**Fix lens:** Jakub — production polish, but selective. See `references/perspectives/jakub-krehel.md`.
...
**Fix lens:** Emil for utility-shaped elements (none); Jakub for product-shaped elements (selective). See `references/perspectives/emil-kowalski.md` and `references/perspectives/jakub-krehel.md`.
...
**Fix lens:** Emil for utility lists (no stagger); Jhey for delight moments (selective). See `references/perspectives/emil-kowalski.md` and `references/perspectives/jhey-tompkins.md`.
...
**Fix lens:** Emil — speed and purpose. See `references/perspectives/emil-kowalski.md`.
...
**Fix lens:** Jakub — selective polish with hierarchy. See `references/perspectives/jakub-krehel.md`.
...
**Fix lens:** Emil — animations should serve a purpose, not announce themselves. See `references/perspectives/emil-kowalski.md`.
