...
description: Systematic checklist for reviewing motion design in any UI code. Use in Audit mode to evaluate existing animations.
---
...
- [ ] Custom Bezier curves used instead of built-in easing (Emil's rule)
