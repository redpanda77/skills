---
name: probabilistic
description: Express confidence in ranges, update predictions with new information, and track calibration over time. Reference when project estimation, risk assessment, and decision making under uncertainty.
---
