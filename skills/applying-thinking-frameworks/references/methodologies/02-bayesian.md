---
name: bayesian
description: Update beliefs systematically based on new evidence using probabilistic reasoning. Reference when estimating probabilities, learning from data, or making decisions under uncertainty.
---
