---
name: via-negativa
description: Improve by removal rather than addition. Focus on what to stop doing, eliminate the negative, and subtract complexity. Reference when system simplification, process improvement, and feature prioritization.
---
