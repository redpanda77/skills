---
name: reversibility
description: Classify decisions by reversibility and match decision process to decision type. Reference when technology choices, architecture decisions, process changes, and hiring decisions.
---
