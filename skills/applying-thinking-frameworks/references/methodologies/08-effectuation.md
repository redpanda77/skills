---
name: effectuation
description: Start with means, not goals; co-create with partners; leverage contingencies. Reference when startup strategy, innovation projects, and uncertain/novel domains where planning is unreliable.
---
