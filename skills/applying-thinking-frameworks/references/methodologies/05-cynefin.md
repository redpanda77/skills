---
name: cynefin
description: Classify problems by complexity domain (clear, complicated, complex, chaotic) and match approach to domain. Reference when choosing methodologies, problem framing, and process design.
---
