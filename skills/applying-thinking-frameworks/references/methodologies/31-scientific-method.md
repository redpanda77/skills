...
description: Hypothesis → Prediction → Test → Revise with explicit falsification. Reference when debugging, feature experimentation, performance investigation, and A/B testing design.
---
