---
name: dual-process
description: Apply Kahneman's Dual-Process Theory to recognize when to trust intuition vs engage deliberate analysis. Reference when high-stakes decisions, error-prone contexts, or when balancing speed vs accuracy.
---
