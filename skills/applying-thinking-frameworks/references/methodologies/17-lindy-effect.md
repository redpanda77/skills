---
name: lindy-effect
description: For non-perishable things, future life expectancy is proportional to current age. Reference when technology selection, evaluating frameworks/libraries, and predicting tool longevity.
---
