---
name: steel-manning
description: Argue against the strongest version of opposing positions, not the weakest. Reference when design reviews, evaluating alternatives, conflict resolution, and decision validation.
---
