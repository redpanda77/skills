...
description: Break complex problems into fundamental truths by questioning assumptions and rebuilding from irreducible components. Reference when innovation, challenging status quo, or when conventional solutions fail.
---
