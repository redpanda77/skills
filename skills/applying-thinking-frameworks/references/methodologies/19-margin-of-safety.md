...
description: Build in buffers for unknown unknowns and don't optimize to the edge. Reference when capacity planning, deadline estimation, architecture design, and risk management.
---
