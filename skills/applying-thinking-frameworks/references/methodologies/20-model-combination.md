...
description: Combine multiple mental models for richer analysis. Reference when complex problems requiring multiple lenses, high-stakes decisions, or when single models leave blind spots.
---
