...
description: Choose the right mental model for the problem at hand. Reference when facing new problems, when current approaches fail, or when you need to match tool to context.
---
