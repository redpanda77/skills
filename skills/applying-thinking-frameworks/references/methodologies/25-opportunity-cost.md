...
description: Evaluate decisions by what you give up, not just what you gain. Reference when resource allocation, prioritization, build vs. buy choices, and technical debt evaluation.
---
