---
name: inversion
description: Approach problems backward by identifying paths to failure, then systematically avoiding them. Reference when risk identification, planning, and avoiding obvious mistakes.
---
