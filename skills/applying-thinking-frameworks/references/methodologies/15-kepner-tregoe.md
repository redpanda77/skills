---
name: kepner-tregoe
description: Systematic rational process for complex problem analysis, decision making, and risk assessment. Reference when high-stakes engineering decisions, root cause analysis beyond 5 Whys, and multi-factor evaluations requiring structured criteria.
---
...
Reference when facing multiple concerns, unclear priorities, or overwhelm.
...
Reference when you need to find root cause of a deviation from expected performance.
...
Reference when choosing among alternatives with multiple criteria.
