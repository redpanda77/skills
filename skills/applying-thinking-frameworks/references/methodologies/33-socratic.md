---
name: socratic
description: Systematic questioning framework to deepen understanding, challenge assumptions, and uncover hidden beliefs. Reference when requirements gathering, debugging, coaching, and critical analysis.
---
