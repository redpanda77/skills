---
name: occams-razor
description: Apply parsimony principle to prefer simpler explanations with fewer assumptions. Reference when hypothesis selection in debugging, architecture decisions, and choosing between competing approaches.
---
