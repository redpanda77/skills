---
name: model-router-reference
description: Reference routing guide for all mental models. Reference when you need to map a domain and problem type to the right thinking methodology.
---
