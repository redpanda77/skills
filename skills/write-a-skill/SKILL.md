...
Before scaffolding, read `references/patterns/design.md` and run the design interview with the user. Do not skip this. The interview determines the skill type, scope, information architecture, and progressive disclosure map. Only proceed after the user confirms the design.

## 2. Determine Scope

Using the design interview output, determine the use case and select the pattern:
...
- **Decision framework, principles of operation, reference domain, or troubleshooting** → see the reference structures in references/patterns/design.md.

## 3. Determine Invocation
