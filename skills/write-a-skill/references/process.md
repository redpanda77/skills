...
Before writing anything, read `references/patterns/design.md` and run the design interview. Do not skip this step.

- [ ] **Read `references/patterns/design.md`** — Run the design interview with the user
- [ ] **Determine skill type** — Workflow, decision framework, guardrails, reference domain, principles of operation, or troubleshooting
- [ ] **Map to progressive disclosure** — What goes in frontmatter, SKILL.md, and references
- [ ] **Document critical negative rules** — What does the agent get wrong without this skill
- [ ] **Define 3 scenarios** — When should this skill be consulted
- [ ] **Confirm the design** — User approves the design document before proceeding

## 2. Read & Decide

Using the design interview output, read the relevant references and make decisions:
...
- [ ] **Read pattern-specific reference** — Based on skill type from design interview
  ...
  - Non-workflow → read `references/patterns/design.md` reference structures
